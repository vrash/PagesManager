...
public class VideoPostCreationActivity extends ActionBarActivity {
    ...
    //Upload to graph-video.facebook.com instead of graph.facebook.com
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_video_post_creation);
        if (FBPagesManager.pageTitle != null)
            setTitle(FBPagesManager.pageTitle + " Feed");
        message = (EditText) findViewById(R.id.vidmsg);
        camImage = (ImageView) findViewById(R.id.vidthmbnail);
        pubSwitch = (Switch) findViewById(R.id.pubVideoSwitch);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_video_post_creation, menu);
        return true;
    }
